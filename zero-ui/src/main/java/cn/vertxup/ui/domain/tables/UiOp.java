...
public class UiOp extends TableImpl<UiOpRecord> {
    ...
    /**
     * The column <code>ZDB.UI_OP.KEY</code>. 「key」- 操作主键
     */
    ...
    /**
     * The column <code>ZDB.UI_OP.ACTION</code>. 「action」-
    ...
    /**
     * The column <code>ZDB.UI_OP.EVENT</code>. 「event」- 操作中的 event 事件名称
     */
    ...
    /**
     * The column <code>ZDB.UI_OP.CLIENT_KEY</code>. 「clientKey」-
    ...
    /**
     * The column <code>ZDB.UI_OP.CLIENT_ID</code>. 「clientId」- 没有特殊情况，clientId
     * = clientKey
     */
    ...
    /**
     * The column <code>ZDB.UI_OP.CONFIG</code>. 「config」- 该按钮操作对应的配置数据信息, icon,
     * type
     */
    ...
    /**
     * The column <code>ZDB.UI_OP.PLUGIN</code>. 「plugin」- 该按钮中的插件，如
     * tooltip，component等
     */
    ...
    /**
     * The column <code>ZDB.UI_OP.UI_SORT</code>. 「uiSort」- 按钮在管理过程中的排序
     */
