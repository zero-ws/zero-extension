...
import cn.vertxup.doc.domain.tables.interfaces.IDDocSegment;
...
public class DDocSegment implements VertxPojo, IDDocSegment {
    ...
    public DDocSegment(IDDocSegment value) {
        ...
        this.contentMeta = value.getContentMeta();
     ...
     */
    @Override
    public DDocSegment setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     */
    @Override
    public DDocSegment setContentMeta(String contentMeta) {
        this.contentMeta = contentMeta;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.contentMeta == null) {
            if (other.contentMeta != null)
                return false;
        }
        else if (!this.contentMeta.equals(other.contentMeta))
            return false;
        if (this.sort == null) {
            if (other.sort != null)
                return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.contentMeta == null) ? 0 : this.contentMeta.hashCode());
