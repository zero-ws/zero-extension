...
import cn.vertxup.battery.domain.Zdb;
...
public class BBag extends TableImpl<BBagRecord> {
    ...
    /**
     * The column <code>ZDB.B_BAG.KEY</code>. 「key」- 模块主键
     */
    ...
    /**
     * The column <code>ZDB.B_BAG.NAME</code>. 「name」- 模块名称
     */
    ...
    /**
     * The column <code>ZDB.B_BAG.TYPE</code>. 「type」- 包类型
     */
    ...
    /**
     * The column <code>ZDB.B_BAG.ENTRY_ID</code>. 「entryId」- 入口专用ID，关联 X_MENU
     * 中的ID，其余的直接使用链接
     */
