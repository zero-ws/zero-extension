...
public class EIdentity extends TableImpl<EIdentityRecord> {
    ...
    /**
     * The column <code>ZDB.E_IDENTITY.KEY</code>. 「key」- 身份主键
     */
