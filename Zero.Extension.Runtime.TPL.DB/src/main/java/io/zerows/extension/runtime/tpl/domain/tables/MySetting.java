...
public class MySetting extends TableImpl<MySettingRecord> {
    ...
    /**
     * The column <code>ZDB.MY_SETTING.KEY</code>. 「key」- 个人设置主键
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.P_NAV_THEME</code>. 「pNavTheme」-
    ...
    /**
     * The column <code>ZDB.MY_SETTING.P_PWA</code>. 「pPwa」- pwa属性，暂时未知
     */
    public final TableField<MySettingRecord, Boolean> P_PWA = createField(DSL.name("P_PWA"), SQLDataType.BIT, this, "「pPwa」- pwa属性，暂时未知");
    /**
     * The column <code>ZDB.MY_SETTING.P_TOKEN</code>. 「pToken」- 保留（后续可能会使用）
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.MY_BAG</code>. 「myBag」- 对应 MY_BAG
     * 设置，每个BAG有对应设置信息
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.OWNER</code>. 「owner」- 拥有者ID，我的 / 角色级
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.OWNER_TYPE</code>. 「ownerType」- ROLE
     * 角色，USER 用户
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.TYPE</code>. 「type」- 类型（默认全站）
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>ZDB.MY_SETTING.LANGUAGE</code>. 「language」- 使用的语言
     */
