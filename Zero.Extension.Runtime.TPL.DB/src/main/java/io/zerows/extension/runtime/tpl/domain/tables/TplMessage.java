...
public class TplMessage extends TableImpl<TplMessageRecord> {
    ...
    /**
     * The column <code>ZDB.TPL_MESSAGE.KEY</code>. 「key」- 模板唯一主键
     */
    ...
    /**
     * The column <code>ZDB.TPL_MESSAGE.EXPR_CONTENT</code>. 「exprContent」-
     * 模板内容，支持表达式
     */
    ...
    /**
     * The column <code>ZDB.TPL_MESSAGE.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>ZDB.TPL_MESSAGE.LANGUAGE</code>. 「language」- 使用的语言
     */
