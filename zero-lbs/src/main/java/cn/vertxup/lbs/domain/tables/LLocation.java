...
public class LLocation extends TableImpl<LLocationRecord> {
    ...
    /**
     * The column <code>ZDB.L_LOCATION.KEY</code>. 「key」- 主键
     */
    ...
    /**
     * The column <code>ZDB.L_LOCATION.CODE</code>. 「code」- 编码
     */
    ...
    /**
     * The column <code>ZDB.L_LOCATION.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>ZDB.L_LOCATION.LANGUAGE</code>. 「language」- 使用的语言
     */
     ...
     */
    public <U> SelectField<U> mapping(Function22<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function22<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
