...
public class LState extends TableImpl<LStateRecord> {
    ...
    /**
     * The column <code>ZDB.L_STATE.KEY</code>. 「key」- 省会主键
     */
    ...
    /**
     * The column <code>ZDB.L_STATE.NAME</code>. 「name」- 省会名称
     */
    ...
    /**
     * The column <code>ZDB.L_STATE.LANGUAGE</code>. 「language」- 使用的语言
     */
     ...
     */
    public <U> SelectField<U> mapping(Function14<? super String, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function14<? super String, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
