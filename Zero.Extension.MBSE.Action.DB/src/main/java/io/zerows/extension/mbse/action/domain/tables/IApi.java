 ...
 */
package io.zerows.extension.mbse.action.domain.tables;


import io.zerows.extension.mbse.action.domain.Keys;
import io.zerows.extension.mbse.action.domain.Zdb;
...
public class IApi extends TableImpl<IApiRecord> {
    ...
    /**
     * The column <code>ZDB.I_API.KEY</code>. 「key」- 接口ID
     */
    ...
    /**
     * The column <code>ZDB.I_API.METHOD</code>. 「method」- 接口对应的HTTP方法
     */
    ...
    /**
     * The column <code>ZDB.I_API.CONSUMES</code>. 「consumes」- 当前接口使用的客户端 MIME
     */
    ...
    /**
     * The column <code>ZDB.I_API.PRODUCES</code>. 「produces」- 当前接口使用的服务端 MIME
     */
    ...
    /**
     * The column <code>ZDB.I_API.SECURE</code>. 「secure」- 是否走安全通道，默认为TRUE
     */
    ...
    /**
     * The column <code>ZDB.I_API.PARAM_MODE</code>. 「paramMode」- 参数来源，QUERY /
     * BODY / DEFINE / PATH
     */
    ...
    /**
     * The column <code>ZDB.I_API.PARAM_REQUIRED</code>. 「paramRequired」-
    ...
    /**
     * The column <code>ZDB.I_API.IN_RULE</code>. 「inRule」- 参数验证、转换基本规则
     */
    ...
    /**
     * The column <code>ZDB.I_API.IN_SCRIPT</code>. 「inScript」- 【保留】参数请求流程中的脚本控制
     */
    ...
    /**
     * The column <code>ZDB.I_API.WORKER_TYPE</code>. 「workerType」- Worker类型：JS
     * / PLUG / STD
     */
    ...
    /**
     * The column <code>ZDB.I_API.WORKER_CLASS</code>. 「workerClass」- OX |
    ...
    /**
     * The column <code>ZDB.I_API.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.I_API.METADATA</code>. 「metadata」- 附加配置数据
     */
