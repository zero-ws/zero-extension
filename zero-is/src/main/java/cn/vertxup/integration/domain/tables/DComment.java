...
public class DComment extends TableImpl<DCommentRecord> {
    ...
    /**
     * The reference instance of <code>DB_ETERNAL.D_COMMENT</code>
     */
    public static final DComment D_COMMENT = new DComment();
    private static final long serialVersionUID = 1L;
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.KEY</code>. 「key」- 解读主键
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<DCommentRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(32), this, "「sigma」- 统一标识");
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<DCommentRecord, Boolean> ACTIVE = createField(DSL.name("ACTIVE"), SQLDataType.BIT, this, "「active」- 是否启用");
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.METADATA</code>. 「metadata」- 附加配置数据
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.MADE_NAME</code>. 「madeName」- 备注人姓名
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.MADE_AT</code>. 「madeAt」- 备注时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.CREATED_AT</code>. 「createdAt」-
     * 创建时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.UPDATED_AT</code>. 「updatedAt」-
     * 更新时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_COMMENT.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>DB_ETERNAL.D_COMMENT</code> table reference
     */
    ...
    /**
     * Create a <code>DB_ETERNAL.D_COMMENT</code> table reference
     */
    public DComment() {
     ...
     */
    public <U> SelectField<U> mapping(Function18<? super String, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function18<? super String, ? super String, ? super String, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
