...
import cn.vertxup.integration.domain.tables.interfaces.IDRefer;
...
public class DReferRecord extends UpdatableRecordImpl<DReferRecord> implements VertxPojo, Record7<String, String, String, String, Boolean, String, String>, IDRefer {
     ...
     */
    @Override
    public DReferRecord setLinkComponent(String value) {
        set(5, value);
        return this;
    }
    ...
    public Field<String> field6() {
        return DRefer.D_REFER.LINK_COMPONENT;
    }
     ...
     */
    public DReferRecord(String fromId, String fromType, String toId, String toType, Boolean inline, String linkComponent, String comment) {
        super(DRefer.D_REFER);
     ...
     * Create a detached, initialised DReferRecord
     */
    public DReferRecord(cn.vertxup.integration.domain.tables.pojos.DRefer value) {
        super(DRefer.D_REFER);
