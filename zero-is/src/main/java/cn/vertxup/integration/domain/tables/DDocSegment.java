...
public class DDocSegment extends TableImpl<DDocSegmentRecord> {
    ...
    /**
     * The reference instance of <code>DB_ETERNAL.D_DOC_SEGMENT</code>
     */
    public static final DDocSegment D_DOC_SEGMENT = new DDocSegment();
    private static final long serialVersionUID = 1L;
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.KEY</code>. 「key」- 文档主键，唯一标识
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.STATUS</code>. 「status」- 状态
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.CONTENT</code>. 「content」-
     * 章节内容（带格式）
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.CONTENT_TEXT</code>.
     * 「contentText」- 无格式章节内容
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.CONTENT_STORE</code>.
     * 「contentStore」- 存储格式
     */
    public final TableField<DDocSegmentRecord, String> CONTENT_STORE = createField(DSL.name("CONTENT_STORE"), SQLDataType.CLOB, this, "「contentStore」- 存储格式");
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.SORT</code>. 「sort」- 排序
     */
    public final TableField<DDocSegmentRecord, Integer> SORT = createField(DSL.name("SORT"), SQLDataType.INTEGER, this, "「sort」- 排序");
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.LEVEL</code>. 「level」- 章节层级
     */
    public final TableField<DDocSegmentRecord, Integer> LEVEL = createField(DSL.name("LEVEL"), SQLDataType.INTEGER, this, "「level」- 章节层级");
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.DOC_ID</code>. 「docId」-
     * 章节所属文档ID
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.PARENT_ID</code>. 「parentId」-
     * 父章节ID
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<DDocSegmentRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(32), this, "「sigma」- 统一标识");
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.LANGUAGE</code>. 「language」-
     * 使用的语言
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<DDocSegmentRecord, Boolean> ACTIVE = createField(DSL.name("ACTIVE"), SQLDataType.BIT, this, "「active」- 是否启用");
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.METADATA</code>. 「metadata」-
     * 附加配置数据
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.CREATED_AT</code>. 「createdAt」-
     * 创建时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.CREATED_BY</code>. 「createdBy」-
     * 创建人
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.UPDATED_AT</code>. 「updatedAt」-
     * 更新时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC_SEGMENT.UPDATED_BY</code>. 「updatedBy」-
     * 更新人
     */
    ...
    /**
     * Create an aliased <code>DB_ETERNAL.D_DOC_SEGMENT</code> table reference
     */
    ...
    /**
     * Create a <code>DB_ETERNAL.D_DOC_SEGMENT</code> table reference
     */
    public DDocSegment() {
    ...
    public List<UniqueKey<DDocSegmentRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_D_DOC_SEGMENT_NAME);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function21<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function21<? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super LocalDateTime, ? super String, ? super LocalDateTime, ? super String, ? extends U> from) {
