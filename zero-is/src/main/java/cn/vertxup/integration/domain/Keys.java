...
public class Keys {
    ...
    public static final UniqueKey<IMessageRecord> KEY_I_MESSAGE_APP_ID_3 = Internal.createUniqueKey(IMessage.I_MESSAGE, DSL.name("KEY_I_MESSAGE_APP_ID_3"), new TableField[] { IMessage.I_MESSAGE.APP_ID, IMessage.I_MESSAGE.SEND_TO, IMessage.I_MESSAGE.SUBJECT }, true);
