...
public class DDoc extends TableImpl<DDocRecord> {
    ...
    /**
     * The reference instance of <code>DB_ETERNAL.D_DOC</code>
     */
    public static final DDoc D_DOC = new DDoc();
    private static final long serialVersionUID = 1L;
    /**
     * The column <code>DB_ETERNAL.D_DOC.KEY</code>. 「key」- 文档主键，唯一标识
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.VERSION</code>. 「version」- 文档版本, N.N
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.AUTHOR</code>. 「author」- 文档作者
     */
    public final TableField<DDocRecord, String> AUTHOR = createField(DSL.name("AUTHOR"), SQLDataType.VARCHAR(128), this, "「author」- 文档作者");
    /**
     * The column <code>DB_ETERNAL.D_DOC.AUTHOR_OR</code>. 「authorOr」- 第二作者、第三作者
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.FILE_NAME</code>. 「fileName」-
     * 原始文件名，带扩展名
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.FILE_KEY</code>. 「fileKey」-
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.SIGMA</code>. 「sigma」- 统一标识
     */
    public final TableField<DDocRecord, String> SIGMA = createField(DSL.name("SIGMA"), SQLDataType.VARCHAR(32), this, "「sigma」- 统一标识");
    /**
     * The column <code>DB_ETERNAL.D_DOC.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_DOC.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>DB_ETERNAL.D_DOC</code> table reference
     */
    ...
    /**
     * Create a <code>DB_ETERNAL.D_DOC</code> table reference
     */
    public DDoc() {
