...
public class DRefer extends TableImpl<DReferRecord> {
    ...
    /**
     * The reference instance of <code>DB_ETERNAL.D_REFER</code>
     */
    public static final DRefer D_REFER = new DRefer();
    private static final long serialVersionUID = 1L;
    /**
     * The column <code>DB_ETERNAL.D_REFER.FROM_ID</code>. 「fromId」- 从ID
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_REFER.FROM_TYPE</code>. 「fromType」- 从类型
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_REFER.TO_ID</code>. 「toId」- 到ID
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_REFER.TO_TYPE</code>. 「toType」- 到类型
     */
    ...
    /**
     * The column <code>DB_ETERNAL.D_REFER.INLINE</code>. 「inline」- 是否内联
     */
    public final TableField<DReferRecord, Boolean> INLINE = createField(DSL.name("INLINE"), SQLDataType.BIT, this, "「inline」- 是否内联");
    /**
     * The column <code>DB_ETERNAL.D_REFER.LINK_COMPONENT</code>.
     * 「linkComponent」- 关联执行组件（扩展用）
     */
    public final TableField<DReferRecord, String> LINK_COMPONENT = createField(DSL.name("LINK_COMPONENT"), SQLDataType.VARCHAR(255), this, "「linkComponent」- 关联执行组件（扩展用）");
    /**
     * The column <code>DB_ETERNAL.D_REFER.COMMENT</code>. 「comment」- 关系备注
     */
    ...
    /**
     * Create an aliased <code>DB_ETERNAL.D_REFER</code> table reference
     */
    ...
    /**
     * Create a <code>DB_ETERNAL.D_REFER</code> table reference
     */
    public DRefer() {
