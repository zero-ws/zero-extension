...
class ScImage {
    ...
    static Buffer valueImage(final String code, final int width, final int height) {
        // Buffered Image
    ...
    static Future<Buffer> imageGenerated(final String code) {
        return Ux.future(valueImage(code, CONFIG.getImageWidth(), CONFIG.getImageHeight()));
    }
