...
import io.zerows.extension.commerce.finance.domain.tables.interfaces.IFInvoice;
...
public class FInvoiceRecord extends UpdatableRecordImpl<FInvoiceRecord> implements VertxPojo, IFInvoice {
     ...
     * Create a detached, initialised FInvoiceRecord
     */
    public FInvoiceRecord(io.zerows.extension.commerce.finance.domain.tables.pojos.FInvoice value) {
        super(FInvoice.F_INVOICE);
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.KEY</code>. 「key」- 发票主键
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.KEY</code>. 「key」- 发票主键
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.NAME</code>. 「name」- 发票名称
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.NAME</code>. 「name」- 发票名称
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.CODE</code>. 「code」- 发票机器码
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.CODE</code>. 「code」- 发票机器码
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.TYPE</code>. 「type」- 发票类型
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.TYPE</code>. 「type」- 发票类型
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.COMMENT</code>. 「comment」 - 发票备注
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.COMMENT</code>. 「comment」 - 发票备注
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.DESC_LOCATION</code>. 「descLocation」- 地址电话
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.DESC_LOCATION</code>. 「descLocation」- 地址电话
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.LANGUAGE</code>. 「language」- 使用的语言
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.LANGUAGE</code>. 「language」- 使用的语言
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.F_INVOICE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.F_INVOICE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
