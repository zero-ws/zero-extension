...
public class XTagDao extends AbstractVertxDAO<XTagRecord, cn.vertxup.ambient.domain.tables.pojos.XTag, String, Future<List<cn.vertxup.ambient.domain.tables.pojos.XTag>>, Future<cn.vertxup.ambient.domain.tables.pojos.XTag>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<XTagRecord,cn.vertxup.ambient.domain.tables.pojos.XTag,String> {
     ...
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XTag>> findManyByUiStyle(Collection<String> values) {
     ...
     * limited by the given limit
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XTag>> findManyByUiStyle(Collection<String> values, int limit) {
     ...
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XTag>> findManyByUiConfig(Collection<String> values) {
     ...
     * limited by the given limit
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XTag>> findManyByUiConfig(Collection<String> values, int limit) {
