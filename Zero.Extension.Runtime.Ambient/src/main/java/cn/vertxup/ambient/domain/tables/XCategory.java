...
public class XCategory extends TableImpl<XCategoryRecord> {
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.KEY</code>. 「key」- 类型主键
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.PARENT_ID</code>. 「parentId」- 父类ID
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.IDENTIFIER</code>. 「identifier」-
     * 当前类型描述的Model的标识
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.COMMENT</code>. 「comment」- 备注信息
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.TREE_CONFIG</code>. 「treeConfig」-
     * 目录组件运行配置，特殊场景专用
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.RUN_CONFIG</code>. 「runConfig」- 执行组件相关配置
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>ZDB.X_CATEGORY.LANGUAGE</code>. 「language」- 使用的语言
     */
