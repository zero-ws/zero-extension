...
public class WTodoRecord extends UpdatableRecordImpl<WTodoRecord> implements VertxPojo, IWTodo {
    ...
    /**
     * Getter for <code>ZDB.W_TODO.KEY</code>. 「key」- 待办主键
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.SERIAL</code>. 「serial」- 待办编号，使用 X_NUMBER 生成
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.NAME</code>. 「name」- 待办名称（标题）
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.CODE</code>. 「code」- 待办系统码，使用流程时候关联流程的任务ID
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.ICON</code>. 「icon」- 待办显示的图标
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.STATUS</code>. 「status」- 待办状态
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.TYPE</code>. 「type」- 待办类型
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * Getter for <code>ZDB.W_TODO.MODEL_ID</code>. 「modelId」-
     * 关联的模型identifier，用于描述
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * Getter for <code>ZDB.W_TODO.MODEL_KEY</code>. 「modelKey」-
     * 关联的模型记录ID，用于描述哪一个Model中的记录
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.MODEL_CATEGORY</code>. 「modelCategory」-
    ...
    /**
     * Getter for <code>ZDB.W_TODO.MODEL_CATEGORY</code>. 「modelCategory」-
     * 关联的category记录，只包含叶节点
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.W_TODO.PARENT_ID</code>. 「parentId」-
    ...
    /**
     * Getter for <code>ZDB.W_TODO.PARENT_ID</code>. 「parentId」-
     * 待办支持父子集结构，父待办执行时候子待办同样执行
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.TRACE_ID</code>. 「traceId」- 同一个流程的待办执行分组
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.TASK_ID</code>. 「taskId」- 和待办绑定的taskId（任务）
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.TASK_KEY</code>. 「taskKey」- 和待办绑定的taskKey
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.COMMENT</code>. 「comment」- 待办描述
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.METADATA</code>. 「metadata」- 附加配置
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.W_TODO.LANGUAGE</code>. 「language」- 使用的语言
     */
    @Override
