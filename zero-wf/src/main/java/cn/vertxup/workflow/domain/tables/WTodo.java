...
public class WTodo extends TableImpl<WTodoRecord> {
    ...
    /**
     * The reference instance of <code>ZDB.W_TODO</code>
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.KEY</code>. 「key」- 待办主键
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.SERIAL</code>. 「serial」- 待办编号，使用 X_NUMBER 生成
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * The column <code>ZDB.W_TODO.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * The column <code>ZDB.W_TODO.MODEL_CATEGORY</code>. 「modelCategory」-
    ...
    /**
     * The column <code>ZDB.W_TODO.PARENT_ID</code>. 「parentId」-
    ...
    /**
     * The column <code>ZDB.W_TODO.SERIAL_FORK</code>. 「serialFork」- 生成序号的分支序号
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TRACE_ID</code>. 「traceId」- 同一个流程的待办执行分组
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TRACE_ORDER</code>. 「traceOrder」- 待办的处理顺序
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TASK_ID</code>. 「taskId」- 和待办绑定的taskId（任务）
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TASK_KEY</code>. 「taskKey」- 和待办绑定的taskKey
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.COMMENT</code>. 「comment」- 待办描述
     */
    public final TableField<WTodoRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB, this, "「comment」- 待办描述");

    /**
     * The column <code>ZDB.W_TODO.COMMENT_APPROVAL</code>. 「commentApproval」-
     * 审批描述
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.COMMENT_REJECT</code>. 「commentReject」- 拒绝理由
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TO_LOCATION</code>. 「toLocation」- 指定地址区域
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.TO_GROUP</code>. 「toGroup」- 指定用户组
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.ASSIGNED_BY</code>. 「assignedBy」- 待办指派人
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.ASSIGNED_AT</code>. 「assignedAt」- 指派时间
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.ACCEPTED_BY</code>. 「acceptedBy」- 待办接收人
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.ACCEPTED_GROUP</code>. 「acceptedGroup」- 当前处理组
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.ACCEPTED_AT</code>. 「acceptedAt」- 接收时间
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.FINISHED_BY</code>. 「finishedBy」- 待办完成人
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.FINISHED_AT</code>. 「finishedAt」- 完成时间
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>ZDB.W_TODO.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>ZDB.W_TODO</code> table reference
     */
    ...
    /**
     * Create a <code>ZDB.W_TODO</code> table reference
     */
    public WTodo() {
