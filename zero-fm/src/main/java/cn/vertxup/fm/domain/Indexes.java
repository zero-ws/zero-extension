...
public class Indexes {
    ...
    public static final Index F_PAYMENT_ITEM_IDX_F_PAYMENT_ITEM_SETTLEMENT_ID = Internal.createIndex(DSL.name("IDX_F_PAYMENT_ITEM_SETTLEMENT_ID"), FPaymentItem.F_PAYMENT_ITEM, new OrderField[] { FPaymentItem.F_PAYMENT_ITEM.OBJECT_ID }, false);
