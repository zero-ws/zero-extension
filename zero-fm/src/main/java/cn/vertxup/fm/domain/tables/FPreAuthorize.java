...
public class FPreAuthorize extends TableImpl<FPreAuthorizeRecord> {
    ...
    /**
     * The reference instance of <code>ZDB.F_PRE_AUTHORIZE</code>
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.KEY</code>. 「key」- 预授权ID
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.CODE</code>. 「code」 - 预授权系统编号
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.SERIAL</code>. 「serial」 - 预授权单据号
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.STATUS</code>. 「status」 -
     * 预授权状态，Lock/Unlock
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.AMOUNT</code>. 「amount」- 当前预授权刷单金额
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.COMMENT</code>. 「comment」 - 预授权备注
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.EXPIRED_AT</code>.
     * 「expiredAt」——预授权有效期
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.BANK_NAME</code>. 「bankName」-
     * 预授权银行名称
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.BANK_CARD</code>. 「bankCard」-
     * 刷预授权的银行卡号
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.ORDER_ID</code>. 「orderId」-
     * 预授权所属订单ID
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.BILL_ID</code>. 「billId」- 预授权所属账单ID
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.BOOK_ID</code>. 「bookId」- 所属账本ID
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.SIGMA</code>. 「sigma」- 统一标识
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.ACTIVE</code>. 「active」- 是否启用
     */
    public final TableField<FPreAuthorizeRecord, Boolean> ACTIVE = createField(DSL.name("ACTIVE"), SQLDataType.BIT, this, "「active」- 是否启用");

    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.METADATA</code>. 「metadata」- 附加配置数据
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>ZDB.F_PRE_AUTHORIZE.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>ZDB.F_PRE_AUTHORIZE</code> table reference
     */
    ...
    /**
     * Create a <code>ZDB.F_PRE_AUTHORIZE</code> table reference
     */
