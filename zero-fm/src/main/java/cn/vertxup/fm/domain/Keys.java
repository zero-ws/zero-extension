...
public class Keys {
    ...
    public static final UniqueKey<FTransRecord> KEY_F_TRANS_CODE = Internal.createUniqueKey(FTrans.F_TRANS, DSL.name("KEY_F_TRANS_CODE"), new TableField[] { FTrans.F_TRANS.CODE, FTrans.F_TRANS.SIGMA }, true);
    public static final UniqueKey<FTransRecord> KEY_F_TRANS_PRIMARY = Internal.createUniqueKey(FTrans.F_TRANS, DSL.name("KEY_F_TRANS_PRIMARY"), new TableField[] { FTrans.F_TRANS.KEY }, true);
    public static final UniqueKey<FTransRecord> KEY_F_TRANS_SERIAL = Internal.createUniqueKey(FTrans.F_TRANS, DSL.name("KEY_F_TRANS_SERIAL"), new TableField[] { FTrans.F_TRANS.SERIAL, FTrans.F_TRANS.SIGMA }, true);
    public static final UniqueKey<FTransItemRecord> KEY_F_TRANS_ITEM_CODE = Internal.createUniqueKey(FTransItem.F_TRANS_ITEM, DSL.name("KEY_F_TRANS_ITEM_CODE"), new TableField[] { FTransItem.F_TRANS_ITEM.CODE, FTransItem.F_TRANS_ITEM.SIGMA }, true);
    public static final UniqueKey<FTransItemRecord> KEY_F_TRANS_ITEM_PRIMARY = Internal.createUniqueKey(FTransItem.F_TRANS_ITEM, DSL.name("KEY_F_TRANS_ITEM_PRIMARY"), new TableField[] { FTransItem.F_TRANS_ITEM.KEY }, true);
    public static final UniqueKey<FTransItemRecord> KEY_F_TRANS_ITEM_SERIAL = Internal.createUniqueKey(FTransItem.F_TRANS_ITEM, DSL.name("KEY_F_TRANS_ITEM_SERIAL"), new TableField[] { FTransItem.F_TRANS_ITEM.SERIAL, FTransItem.F_TRANS_ITEM.SIGMA }, true);
