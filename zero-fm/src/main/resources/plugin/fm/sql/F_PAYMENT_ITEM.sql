...
(
     ...
     * SETTLEMENT:      结算单
     */
    `OBJECT_ID`   VARCHAR(36)  DEFAULT NULL COMMENT '「objectId」付款对象ID',
    `OBJECT_TYPE` VARCHAR(128) DEFAULT NULL COMMENT '「objectType」付款对象类型',
...
ALTER TABLE F_PAYMENT_ITEM
    ADD INDEX IDX_F_PAYMENT_ITEM_SETTLEMENT_ID (`OBJECT_ID`);
