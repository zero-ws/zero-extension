...
public class SPath extends TableImpl<SPathRecord> {
    ...
    /**
     * The column <code>ZDB.S_PATH.KEY</code>. 「key」- 规则主键
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.RUN_TYPE</code>. 「runType」- 视图管理类型（查询用）
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.DM_COMPONENT</code>. 「dmComponent」-
     * 必须绑定组专用Dao组件
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.DM_CONFIG</code>. 「dmConfig」- 组配置信息，配置呈现部分
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.UI_SURFACE</code>. 「uiSurface」-
    ...
    /**
     * The column <code>ZDB.S_PATH.UI_SORT</code>. 「sort」- 该板块的排序（前端）
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.S_PATH.METADATA</code>. 「metadata」- 附加配置数据
     */
