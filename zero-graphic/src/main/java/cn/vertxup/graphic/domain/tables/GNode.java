...
public class GNode extends TableImpl<GNodeRecord> {
    ...
    /**
     * The column <code>ZDB.G_NODE.KEY</code>. 「key」- 节点ID
     */
    ...
    /**
     * The column <code>ZDB.G_NODE.NAME</code>. 「name」- 节点呈现名称
     */
    ...
    /**
     * The column <code>ZDB.G_NODE.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.G_NODE.METADATA</code>. 「metadata」- 附加配置数据
     */
