...
public class GCluster extends TableImpl<GClusterRecord> {
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.KEY</code>. 「key」- 组ID
     */
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.NAME</code>. 「name」- 组呈现名称
     */
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.GRAPHIC_ID</code>. 「graphicId」- 它所关联的图实例ID
     */
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.G_CLUSTER.METADATA</code>. 「metadata」- 附加配置数据
     */
