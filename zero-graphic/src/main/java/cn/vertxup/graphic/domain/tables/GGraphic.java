...
import cn.vertxup.graphic.domain.Zdb;
...
public class GGraphic extends TableImpl<GGraphicRecord> {
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.KEY</code>. 「key」- 图ID
     */
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.TYPE</code>. 「type」- 图类型 CIRCLE / DEFINE /
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * The column <code>ZDB.G_GRAPHIC.METADATA</code>. 「metadata」- 附加配置数据
     */
