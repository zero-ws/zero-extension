...
public class MyFavor extends TableImpl<MyFavorRecord> {
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.KEY</code>. 「key」- 个人应用主键
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.OWNER</code>. 「owner」- 拥有者ID，我的 / 角色级
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.OWNER_TYPE</code>. 「ownerType」- ROLE
     * 角色，USER 用户
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.TYPE</code>. 「type」- 类型（默认全站）
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.URI_KEY</code>. 「uriKey」- URI KEY（加密长度）
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.URI_FULL</code>. 「uriFull」- 收藏完整链接地址（带参数部分）
     */
    ...
    /**
     * The column <code>ZDB.MY_FAVOR.URI_PARAM</code>. 「uriParam」- 该收藏参数（收藏夹专用）
     */
