...
public interface IIService extends VertxPojo, Serializable {
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.KEY</code>. 「key」- 服务ID
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.NAMESPACE</code>. 「namespace」- 服务所在名空间
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.NAME</code>. 「name」- 服务名称
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.COMMENT</code>. 「comment」- 备注信息
     */
    public String getComment();

    /**
     * Setter for <code>ZDB.I_SERVICE.IS_WORKFLOW</code>. 「isWorkflow」-
     * 是否驱动工作流引擎
     */
    public IIService setIsWorkflow(Boolean value);

    /**
     * Getter for <code>ZDB.I_SERVICE.IS_WORKFLOW</code>. 「isWorkflow」-
     * 是否驱动工作流引擎
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.IS_GRAPHIC</code>. 「isGraphic」- 是否驱动图引擎
     */
    public Boolean getIsGraphic();

    /**
     * Setter for <code>ZDB.I_SERVICE.IN_SCRIPT</code>. 「inScript」-
     * 本次不使用，加载脚本引擎ScriptEngine前置脚本
     */
    public IIService setInScript(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.IN_SCRIPT</code>. 「inScript」-
     * 本次不使用，加载脚本引擎ScriptEngine前置脚本
     */
    public String getInScript();

    /**
     * Setter for <code>ZDB.I_SERVICE.OUT_SCRIPT</code>. 「outScript」-
     * 本次不使用，加载脚本引擎ScriptEngine后置脚本
     */
    public IIService setOutScript(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.OUT_SCRIPT</code>. 「outScript」-
     * 本次不使用，加载脚本引擎ScriptEngine后置脚本
     */
    public String getOutScript();

    /**
     * Setter for <code>ZDB.I_SERVICE.CHANNEL_TYPE</code>. 「channelType」-
     * 通道类型：ADAPTOR / CONNECTOR / ACTOR / DIRECTOR / DEFINE
     */
    public IIService setChannelType(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.CHANNEL_TYPE</code>. 「channelType」-
     * 通道类型：ADAPTOR / CONNECTOR / ACTOR / DIRECTOR / DEFINE
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.DICT_CONFIG</code>. 「dictConfig」- 字典的配置信息
     */
    ...
    /**
     * Setter for <code>ZDB.I_SERVICE.DICT_EPSILON</code>. 「dictEpsilon」-
     * 字典的消费配置
     */
    public IIService setDictEpsilon(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.DICT_EPSILON</code>. 「dictEpsilon」-
     * 字典的消费配置
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.MAPPING_MODE</code>. 「mappingMode」- 映射的模式
     */
    ...
    /**
     * Setter for <code>ZDB.I_SERVICE.IDENTIFIER</code>. 「identifier」-
     * 当前类型描述的Model的标识
     */
    public IIService setIdentifier(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.IDENTIFIER</code>. 「identifier」-
     * 当前类型描述的Model的标识
     */
    ...
    /**
     * Setter for <code>ZDB.I_SERVICE.RULE_UNIQUE</code>. 「ruleUnique」-
     * 第二标识规则，当前通道的专用标识规则RuleUnique
     */
    public IIService setRuleUnique(String value);

    /**
     * Getter for <code>ZDB.I_SERVICE.RULE_UNIQUE</code>. 「ruleUnique」-
     * 第二标识规则，当前通道的专用标识规则RuleUnique
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * Getter for <code>ZDB.I_SERVICE.METADATA</code>. 「metadata」- 附加配置数据
     */
