...
import io.zerows.extension.commerce.rbac.domain.tables.interfaces.IRGroupRole;
...
public class RGroupRoleRecord extends UpdatableRecordImpl<RGroupRoleRecord> implements VertxPojo, Record3<String, String, Integer>, IRGroupRole {
     ...
     * Create a detached, initialised RGroupRoleRecord
     */
    public RGroupRoleRecord(io.zerows.extension.commerce.rbac.domain.tables.pojos.RGroupRole value) {
        super(RGroupRole.R_GROUP_ROLE);
    ...
    /**
     * Getter for <code>ZDB.R_GROUP_ROLE.PRIORITY</code>. 「priority」- 角色优先级
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.R_GROUP_ROLE.PRIORITY</code>. 「priority」- 角色优先级
     */
    @Override
