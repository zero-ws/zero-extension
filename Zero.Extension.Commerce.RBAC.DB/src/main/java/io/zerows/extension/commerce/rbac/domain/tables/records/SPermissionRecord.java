...
import io.zerows.extension.commerce.rbac.domain.tables.interfaces.ISPermission;
...
public class SPermissionRecord extends UpdatableRecordImpl<SPermissionRecord> implements VertxPojo, Record13<String, String, String, String, String, String, Boolean, String, String, LocalDateTime, String, LocalDateTime, String>, ISPermission {
     ...
     * Create a detached, initialised SPermissionRecord
     */
    public SPermissionRecord(io.zerows.extension.commerce.rbac.domain.tables.pojos.SPermission value) {
        super(SPermission.S_PERMISSION);
    ...
    /**
     * Getter for <code>ZDB.S_PERMISSION.SIGMA</code>. 「sigma」- 绑定的统一标识
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_PERMISSION.SIGMA</code>. 「sigma」- 绑定的统一标识
     */
    @Override
