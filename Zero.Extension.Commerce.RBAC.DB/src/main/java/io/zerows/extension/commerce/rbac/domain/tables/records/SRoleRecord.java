...
import io.zerows.extension.commerce.rbac.domain.tables.interfaces.ISRole;
...
public class SRoleRecord extends UpdatableRecordImpl<SRoleRecord> implements VertxPojo, Record16<String, String, String, Boolean, String, String, String, String, String, String, Boolean, String, LocalDateTime, String, LocalDateTime, String>, ISRole {
     ...
     * Create a detached, initialised SRoleRecord
     */
    public SRoleRecord(io.zerows.extension.commerce.rbac.domain.tables.pojos.SRole value) {
        super(SRole.S_ROLE);
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.KEY</code>. 「key」- 角色ID
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.KEY</code>. 「key」- 角色ID
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.NAME</code>. 「name」- 角色名称
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.NAME</code>. 「name」- 角色名称
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.CODE</code>. 「code」- 角色系统名
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.CODE</code>. 「code」- 角色系统名
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.POWER</code>. 「power」- 是否具有定制权限？
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.POWER</code>. 「power」- 是否具有定制权限？
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.COMMENT</code>. 「comment」- 角色备注信息
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.COMMENT</code>. 「comment」- 角色备注信息
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.MODEL_ID</code>. 「modelId」-
     * 组所关联的模型identifier，用于描述
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.MODEL_KEY</code>. 「modelKey」-
     * 组所关联的模型记录ID，用于描述哪一个Model中的记录
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.CATEGORY</code>. 「category」- 组类型
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.CATEGORY</code>. 「category」- 组类型
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.LANGUAGE</code>. 「language」- 使用的语言
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.LANGUAGE</code>. 「language」- 使用的语言
     */
    @Override
    ...
    /**
     * Getter for <code>ZDB.S_ROLE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
    ...
    /**
     * Setter for <code>ZDB.S_ROLE.METADATA</code>. 「metadata」- 附加配置数据
     */
    @Override
