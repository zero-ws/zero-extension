...
public interface OData {
    ...
    Cc<String, OData> CC_SKELETON = Cc.openThread();

    static OData of(final String valuePath) {
        Objects.requireNonNull(valuePath);
            return CC_SKELETON.pick(ODataClass::new, valuePath);
     ...
     * @return 计算的值
     */
    Future<JsonArray> dataAsync(JsonArray dataSource, JsonObject params, KpDataSet dataSet);
    interface T {
