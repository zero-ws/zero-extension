...
public class XAttachment extends TableImpl<XAttachmentRecord> {
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.KEY</code>. 「key」- 附件的ID值
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.NAME</code>. 「name」- 文件名（带扩展名）
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.TYPE</code>. 「type」-
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.MIME</code>. 「mime」- 该文件的MIME类型
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.SIZE</code>. 「size」- 该文件的尺寸
     */
    public final TableField<XAttachmentRecord, Integer> SIZE = createField(DSL.name("SIZE"), SQLDataType.INTEGER, this, "「size」- 该文件的尺寸");

    /**
     * The column <code>ZDB.X_ATTACHMENT.STATUS</code>. 「status」- 状态，PROGRESS /
     * SUCCESS
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.STORE_URI</code>. 「storeUri」-
     * 远程存储的目录URI部分
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.MODEL_ID</code>. 「modelId」-
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.MODEL_KEY</code>. 「modelKey」-
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.FILE_NAME</code>. 「fileName」-
     * 原始文件名（不带扩展名）
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.FILE_KEY</code>. 「fileKey」-
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.FILE_URL</code>. 「fileUrl」-
     * 该文件的下载链接（全局唯一）
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.FILE_PATH</code>. 「filePath」-
     * 该文件的存储地址，FILE时使用
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.METADATA</code>. 「metadata」- 附加配置
     */
    ...
    /**
     * The column <code>ZDB.X_ATTACHMENT.LANGUAGE</code>. 「language」- 使用的语言
     */
