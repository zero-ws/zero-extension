...
public class XNumberDao extends AbstractVertxDAO<XNumberRecord, cn.vertxup.ambient.domain.tables.pojos.XNumber, String, Future<List<cn.vertxup.ambient.domain.tables.pojos.XNumber>>, Future<cn.vertxup.ambient.domain.tables.pojos.XNumber>, Future<Integer>, Future<String>> implements io.github.jklingsporn.vertx.jooq.classic.VertxDAO<XNumberRecord,cn.vertxup.ambient.domain.tables.pojos.XNumber,String> {
     ...
     * asynchronously
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XNumber>> findManyByRunComponent(Collection<String> values) {
                return findManyByCondition(XNumber.X_NUMBER.RUN_COMPONENT.in(values));
        }
     ...
     */
        public Future<List<cn.vertxup.ambient.domain.tables.pojos.XNumber>> findManyByRunComponent(Collection<String> values, int limit) {
                return findManyByCondition(XNumber.X_NUMBER.RUN_COMPONENT.in(values),limit);
        }
