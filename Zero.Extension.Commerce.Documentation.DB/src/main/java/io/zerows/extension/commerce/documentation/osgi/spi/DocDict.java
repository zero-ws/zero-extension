...
import io.zerows.extension.commerce.documentation.domain.tables.daos.DDocDao;

/*
 * Dict for `resource.docs` here
 */
public class DocDict implements DictionaryPlugin {
    ...
    public Future<JsonArray> fetchAsync(final KDictSource source,
        ...
        if (Ut.isNotNil(sigma)) {
            return Ux.Jooq.on(DDocDao.class)
