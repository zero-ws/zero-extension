...
public interface IPOutItem extends VertxPojo, Serializable {
    ...
    /**
     * Setter for <code>ZDB.P_OUT_ITEM.KEY</code>. 「key」- 出库明细主键
     */
    public IPOutItem setKey(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.KEY</code>. 「key」- 出库明细主键
     */
    public String getKey();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.SERIAL</code>. 「serial」- 出库明细号（系统可用，直接计算）
     */
    public IPOutItem setSerial(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.SERIAL</code>. 「serial」- 出库明细号（系统可用，直接计算）
     */
    public String getSerial();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.STATUS</code>. 「status」- 明细状态
     */
    public IPOutItem setStatus(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.STATUS</code>. 「status」- 明细状态
     */
    public String getStatus();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COMMODITY_ID</code>. 「commodityId」- 商品ID
     */
    public IPOutItem setCommodityId(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COMMODITY_ID</code>. 「commodityId」- 商品ID
     */
    public String getCommodityId();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COMMODITY_CODE</code>. 「commodityCode」-
     * 商品编码
     */
    public IPOutItem setCommodityCode(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COMMODITY_CODE</code>. 「commodityCode」-
     * 商品编码
     */
    public String getCommodityCode();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COMMODITY_NAME</code>. 「commodityName」-
     * 商品名称
     */
    public IPOutItem setCommodityName(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COMMODITY_NAME</code>. 「commodityName」-
     * 商品名称
     */
    public String getCommodityName();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COMMODITY_LOGO</code>. 「commodityLogo」-
     * 商品Logo
     */
    public IPOutItem setCommodityLogo(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COMMODITY_LOGO</code>. 「commodityLogo」-
     * 商品Logo
     */
    public String getCommodityLogo();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.CUSTOMER_ID</code>. 「customerId」- 供应商
     */
    public IPOutItem setCustomerId(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.CUSTOMER_ID</code>. 「customerId」- 供应商
     */
    public String getCustomerId();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.FROM_NAME</code>. 「fromName」- 供应商商品名称
     */
    public IPOutItem setFromName(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.FROM_NAME</code>. 「fromName」- 供应商商品名称
     */
    public String getFromName();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.FROM_CODE</code>. 「fromCode」- 供应商商品编码
     */
    public IPOutItem setFromCode(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.FROM_CODE</code>. 「fromCode」- 供应商商品编码
     */
    public String getFromCode();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.TICKET_ID</code>. 「ticketId」- 出库单ID
     */
    public IPOutItem setTicketId(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.TICKET_ID</code>. 「ticketId」- 出库单ID
     */
    public String getTicketId();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.WH_ID</code>. 「whId」- 实际出库仓库
     */
    public IPOutItem setWhId(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.WH_ID</code>. 「whId」- 实际出库仓库
     */
    public String getWhId();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.NUM</code>. 「num」- 实际出库数量
     */
    public IPOutItem setNum(Integer value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.NUM</code>. 「num」- 实际出库数量
     */
    public Integer getNum();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.AMOUNT</code>. 「amount」- 销售总价（订单总价）
     */
    public IPOutItem setAmount(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.AMOUNT</code>. 「amount」- 销售总价（订单总价）
     */
    public BigDecimal getAmount();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.PRICE</code>. 「price」- 销售单价（销售价）
     */
    public IPOutItem setPrice(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.PRICE</code>. 「price」- 销售单价（销售价）
     */
    public BigDecimal getPrice();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COMMENT</code>. 「comment」- 商品行备注
     */
    public IPOutItem setComment(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COMMENT</code>. 「comment」- 商品行备注
     */
    public String getComment();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COST_PER_BASIS</code>. 「costPerBasis」-
     * 基本单位成本
     */
    public IPOutItem setCostPerBasis(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COST_PER_BASIS</code>. 「costPerBasis」-
     * 基本单位成本
     */
    public BigDecimal getCostPerBasis();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COST_PER</code>. 「costPer」- 单位成本
     */
    public IPOutItem setCostPer(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COST_PER</code>. 「costPer」- 单位成本
     */
    public BigDecimal getCostPer();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.COST_AMOUNT</code>. 「costAmount」- 出库成本
     */
    public IPOutItem setCostAmount(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.COST_AMOUNT</code>. 「costAmount」- 出库成本
     */
    public BigDecimal getCostAmount();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.DISCOUNT_AMOUNT</code>. 「discountAmount」-
     * 折扣金额
     */
    public IPOutItem setDiscountAmount(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.DISCOUNT_AMOUNT</code>. 「discountAmount」-
     * 折扣金额
     */
    public BigDecimal getDiscountAmount();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.DISCOUNT_RATE</code>. 「discountRate」- 折扣率
     */
    public IPOutItem setDiscountRate(BigDecimal value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.DISCOUNT_RATE</code>. 「discountRate」- 折扣率
     */
    public BigDecimal getDiscountRate();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.ACTIVE</code>. 「active」- 是否启用
     */
    public IPOutItem setActive(Boolean value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.ACTIVE</code>. 「active」- 是否启用
     */
    public Boolean getActive();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.SIGMA</code>. 「sigma」- 统一标识
     */
    public IPOutItem setSigma(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.SIGMA</code>. 「sigma」- 统一标识
     */
    public String getSigma();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.METADATA</code>. 「metadata」- 附加配置
     */
    public IPOutItem setMetadata(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.METADATA</code>. 「metadata」- 附加配置
     */
    public String getMetadata();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.LANGUAGE</code>. 「language」- 使用的语言
     */
    public IPOutItem setLanguage(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.LANGUAGE</code>. 「language」- 使用的语言
     */
    public String getLanguage();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    public IPOutItem setCreatedAt(LocalDateTime value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    public LocalDateTime getCreatedAt();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.CREATED_BY</code>. 「createdBy」- 创建人
     */
    public IPOutItem setCreatedBy(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.CREATED_BY</code>. 「createdBy」- 创建人
     */
    public String getCreatedBy();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    public IPOutItem setUpdatedAt(LocalDateTime value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    public LocalDateTime getUpdatedAt();

    /**
     * Setter for <code>ZDB.P_OUT_ITEM.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    public IPOutItem setUpdatedBy(String value);

    /**
     * Getter for <code>ZDB.P_OUT_ITEM.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
