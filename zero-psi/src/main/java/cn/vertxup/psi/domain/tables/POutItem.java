...
public class POutItem extends TableImpl<POutItemRecord> {
    ...
    /**
     * The reference instance of <code>ZDB.P_OUT_ITEM</code>
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.KEY</code>. 「key」- 出库明细主键
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.SERIAL</code>. 「serial」- 出库明细号（系统可用，直接计算）
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COMMODITY_CODE</code>. 「commodityCode」-
     * 商品编码
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COMMODITY_NAME</code>. 「commodityName」-
     * 商品名称
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COMMODITY_LOGO</code>. 「commodityLogo」-
     * 商品Logo
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.CUSTOMER_ID</code>. 「customerId」- 供应商
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.FROM_NAME</code>. 「fromName」- 供应商商品名称
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.FROM_CODE</code>. 「fromCode」- 供应商商品编码
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.TICKET_ID</code>. 「ticketId」- 出库单ID
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.PRICE</code>. 「price」- 销售单价（销售价）
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COMMENT</code>. 「comment」- 商品行备注
     */
    public final TableField<POutItemRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB, this, "「comment」- 商品行备注");

    /**
     * The column <code>ZDB.P_OUT_ITEM.COST_PER_BASIS</code>. 「costPerBasis」-
     * 基本单位成本
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COST_PER</code>. 「costPer」- 单位成本
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.COST_AMOUNT</code>. 「costAmount」- 出库成本
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.DISCOUNT_AMOUNT</code>. 「discountAmount」-
     * 折扣金额
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.DISCOUNT_RATE</code>. 「discountRate」- 折扣率
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>ZDB.P_OUT_ITEM.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>ZDB.P_OUT_ITEM</code> table reference
     */
    ...
    /**
     * Create a <code>ZDB.P_OUT_ITEM</code> table reference
     */
    public POutItem() {
