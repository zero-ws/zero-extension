...
public class PBuyItem extends TableImpl<PBuyItemRecord> {
    ...
    /**
     * The reference instance of <code>ZDB.P_BUY_ITEM</code>
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.KEY</code>. 「key」- 采购明细主键
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.SERIAL</code>. 「serial」- 采购单号（系统可用，直接计算）
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.COMMODITY_CODE</code>. 「commodityCode」-
     * 商品编码
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.COMMODITY_NAME</code>. 「commodityName」-
     * 商品名称
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.CUSTOMER_ID</code>. 「customerId」- 建议供应商
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.TICKET_ID</code>. 「ticketId」- 采购申请ID
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.ORDER_ID</code>. 「orderId」- 采购订单ID
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.NUM_REQUEST</code>. 「numRequest」- 申请数量
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.NUM_APPROVED</code>. 「numApproved」- 审批数量
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.TAX_AMOUNT</code>. 「taxAmount」- 税额
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.TAX_PRICE</code>. 「taxPrice」- 含税单价
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.AMOUNT_TOTAL</code>. 「amountTotal」- 税价合计
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.AMOUNT_SPLIT</code>. 「amountSplit」-
     * 采购分摊费用
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.AMOUNT</code>. 「amount」- 采购总价（订单总价）
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.PRICE</code>. 「price」- 采购单价（采购价）
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.DISCOUNT_AMOUNT</code>. 「discountAmount」-
     * 折扣金额
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.DISCOUNT_RATE</code>. 「discountRate」- 折扣率
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.COMMENT</code>. 「comment」- 商品行备注
     */
    public final TableField<PBuyItemRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB, this, "「comment」- 商品行备注");

    /**
     * The column <code>ZDB.P_BUY_ITEM.ARRIVE_AT</code>. 「arriveAt」- 预计到货时间
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>ZDB.P_BUY_ITEM.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>ZDB.P_BUY_ITEM</code> table reference
     */
    ...
    /**
     * Create a <code>ZDB.P_BUY_ITEM</code> table reference
     */
    public PBuyItem() {
