...
public class PInItem extends TableImpl<PInItemRecord> {
    ...
    /**
     * The reference instance of <code>ZDB.P_IN_ITEM</code>
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.KEY</code>. 「key」- 入库明细主键
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.SERIAL</code>. 「serial」- 入库明细号（系统可用，直接计算）
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COMMODITY_CODE</code>. 「commodityCode」-
     * 商品编码
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COMMODITY_NAME</code>. 「commodityName」-
     * 商品名称
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COMMODITY_LOGO</code>. 「commodityLogo」-
     * 商品Logo
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.CUSTOMER_ID</code>. 「customerId」- 供应商
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.FROM_NAME</code>. 「fromName」- 供应商商品名称
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.FROM_CODE</code>. 「fromCode」- 供应商商品编码
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.TICKET_ID</code>. 「ticketId」- 入库单ID
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.ORDER_NUMBER</code>. 「orderNumber」- 订单编号
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.ORDER_SOURCE</code>. 「orderSource」- 源单单号
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.TAX_AMOUNT</code>. 「taxAmount」- 税额
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.TAX_PRICE</code>. 「taxPrice」- 含税单价
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.AMOUNT_TOTAL</code>. 「amountTotal」- 税价合计
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.AMOUNT_SPLIT</code>. 「amountSplit」- 采购分摊费用
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.AMOUNT</code>. 「amount」- 采购总价（订单总价）
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.PRICE</code>. 「price」- 采购单价（采购价）
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COMMENT</code>. 「comment」- 商品行备注
     */
    public final TableField<PInItemRecord, String> COMMENT = createField(DSL.name("COMMENT"), SQLDataType.CLOB, this, "「comment」- 商品行备注");

    /**
     * The column <code>ZDB.P_IN_ITEM.COST_PER_BASIS</code>. 「costPerBasis」-
     * 基本单位成本
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COST_PER</code>. 「costPer」- 单位成本
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.COST_AMOUNT</code>. 「costAmount」- 入库成本
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.DISCOUNT_AMOUNT</code>. 「discountAmount」-
     * 折扣金额
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.DISCOUNT_RATE</code>. 「discountRate」- 折扣率
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.CREATED_AT</code>. 「createdAt」- 创建时间
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.CREATED_BY</code>. 「createdBy」- 创建人
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.UPDATED_AT</code>. 「updatedAt」- 更新时间
     */
    ...
    /**
     * The column <code>ZDB.P_IN_ITEM.UPDATED_BY</code>. 「updatedBy」- 更新人
     */
    ...
    /**
     * Create an aliased <code>ZDB.P_IN_ITEM</code> table reference
     */
    ...
    /**
     * Create a <code>ZDB.P_IN_ITEM</code> table reference
     */
    public PInItem() {
