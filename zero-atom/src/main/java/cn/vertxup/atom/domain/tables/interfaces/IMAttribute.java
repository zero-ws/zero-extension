...
public interface IMAttribute extends VertxPojo, Serializable {
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.KEY</code>. 「key」- 属性ID
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.NAME</code>. 「name」- 属性名称
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.ALIAS</code>. 「alias」- 属性别名（业务名）
     */
    public String getAlias();

    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.TYPE</code>. 「type」-
     * INTERNAL/EXTERNAL/REFERENCE属性
     */
    public IMAttribute setType(String value);

    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.TYPE</code>. 「type」-
     * INTERNAL/EXTERNAL/REFERENCE属性
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.MODEL_ID</code>. 「modelId」- 关联的模型ID
     */
    ...
    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.SOURCE_FIELD</code>. 「sourceField」-
     * 可选，如果不设置则以name为主
     */
    public IMAttribute setSourceField(String value);

    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.SOURCE_FIELD</code>. 「sourceField」-
     * 可选，如果不设置则以name为主
     */
    ...
    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.IS_ARRAY</code>. 「isArray」-
     * 是否集合属性，集合属性在导入导出时可用（保留）
     */
    public IMAttribute setIsArray(Boolean value);

    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.IS_ARRAY</code>. 「isArray」-
     * 是否集合属性，集合属性在导入导出时可用（保留）
     */
    public Boolean getIsArray();

    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.IS_REFER</code>. 「isRefer」-
     * 是否引用属性的主属性，主属性才可拥有 sourceReference 配置，根据 source 有区别
     */
    public IMAttribute setIsRefer(Boolean value);

    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.IS_REFER</code>. 「isRefer」-
     * 是否引用属性的主属性，主属性才可拥有 sourceReference 配置，根据 source 有区别
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.IS_LOCK</code>. 「isLock」- 是否锁定，锁定属性不可删除
     */
    public Boolean getIsLock();

    /**
     * Setter for <code>ZDB.M_ATTRIBUTE.IS_TRACK</code>. 「isTrack」- 是否实现历史记录，如果是
     * isTrack 那么启用 ACTIVITY 的变更记录，对应 ITEM
     */
    public IMAttribute setIsTrack(Boolean value);

    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.IS_TRACK</code>. 「isTrack」- 是否实现历史记录，如果是
     * isTrack 那么启用 ACTIVITY 的变更记录，对应 ITEM
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.LANGUAGE</code>. 「language」- 使用的语言
     */
    ...
    /**
     * Getter for <code>ZDB.M_ATTRIBUTE.METADATA</code>. 「metadata」- 附加配置数据
     */
