package io.zerows.extension.runtime.boot.supply;
...
import io.zerows.extension.runtime.exception._417LoadingNotReadyException;
import io.zerows.feature.web.cache.shared.MapInfix;
import io.zerows.feature.web.cache.shared.SharedClient;
...
import static io.zerows.extension.runtime.refine.Ke.LOG;
...
public class DataImport {
    ...
    private Future<Boolean> future(final String folder, final String prefix, final boolean oob) {
        ...
        return Fn.combineT(files).compose(nil -> Ux.future(Boolean.TRUE));
    }
